...
fun BookingFormScreen(onBack: () -> Unit, onSuccess: () -> Unit) {
    ...
    val galleryLauncher = androidx.activity.compose.rememberLauncherForActivityResult(
        ...
        runCatching {
            ...
            vm.addPendingPhoto(com.sspd.servicemgmt.core.util.ImageCodec.bitmapToDataUri(bmp))
        }
    }
    val cameraLauncher = androidx.activity.compose.rememberLauncherForActivityResult(
        androidx.activity.result.contract.ActivityResultContracts.TakePicturePreview()
    ) { bmp -> bmp?.let { vm.addPendingPhoto(com.sspd.servicemgmt.core.util.ImageCodec.bitmapToDataUri(it)) } }
