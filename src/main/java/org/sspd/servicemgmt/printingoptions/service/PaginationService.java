...
public class PaginationService {
    ...
    private PrintInvoiceData pageSnapshot(
        ...
        return PrintInvoiceData.builder()
                ...
                .showColRowNo(base.isShowColRowNo())
                .showColItem(base.isShowColItem())
                .showColQty(base.isShowColQty())
                .showColUnitPrice(base.isShowColUnitPrice())
                .showColAmount(base.isShowColAmount())
                .showColWarranty(base.isShowColWarranty())
                .showColLineDiscount(base.isShowColLineDiscount())
