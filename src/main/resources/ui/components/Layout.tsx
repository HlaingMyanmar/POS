...
const Layout: React.FC<LayoutProps> = ({
  ...
  const menuItems = useMemo(
    () => [
      ...
      { name: 'Customer Chat', icon: <MessageCircle size={18} />, path: AppRoute.CUSTOMER_CHAT_INBOX, group: 'ဖောက်သည်', permission: 'CAN_ACCESS_CUSTOMER_READ' },
      ...
      { name: 'Cash Drawer', icon: <Wallet size={18} />, path: AppRoute.CASH_DRAWER, group: 'စာရင်းကိုင်', permission: 'CAN_ACCESS_CASH_DRAWER_READ' },
      ...
      { name: 'တစ်နေ့တာ Snapshot', icon: <ClipboardList size={18} />, path: AppRoute.DAILY_SNAPSHOT, group: 'အစီရင်ခံစာ', permission: 'CAN_ACCESS_REPORT_READ' },
      ...
      { name: 'Outdoor Tracking', icon: <MapPin size={18} />, path: AppRoute.OUTDOOR_TRACKING, group: 'ဝန်ဆောင်မှု', permission: 'CAN_ACCESS_TECHNICIAN_LOCATION_READ' },
