...
export enum AppRoute {
  ...
  DASHBOARD = '/pos/app',
  USERS = '/pos/rbac/users',
  ROLES = '/pos/rbac/roles',
  PERMISSIONS = '/pos/rbac/permissions',
  PRODUCTS = '/pos/inventory/products',
  PRODUCT_LABELS = '/pos/inventory/barcode-labels',
  PRODUCT_SERIALS = '/pos/inventory/serials',
  BRANDS = '/pos/inventory/brands',
  CATEGORIES = '/pos/inventory/categories',
  UNITS = '/pos/inventory/units',
  SUPPLIERS = '/pos/procurement/suppliers',
  SALES = '/pos/crm/sales',
  WARRANTIES = '/pos/crm/warranties',
  QUOTATIONS = '/pos/crm/quotations',
  CREDIT = '/pos/crm/credit-management',
  CUSTOMERS = '/pos/crm/customers',
  STAFF = '/pos/hr/staff',
  COA = '/pos/accounting/coa',
  PAYMENT_METHODS = '/pos/accounting/payment-methods',
  CASH_DRAWER = '/pos/accounting/cash-drawer',
  ACCOUNTING_DASHBOARD = '/pos/accounting/dashboard',
  JOURNAL_ENTRIES = '/pos/accounting/journal-entries',
  EXPENSE_INCOME = '/pos/accounting/expense-income',
  PURCHASES = '/pos/procurement/purchases',
  PURCHASE_RETURNS = '/pos/procurement/purchase-returns',
  PURCHASE_ORDERS = '/pos/procurement/purchase-orders',
  SALE_RETURNS = '/pos/sale-returns',
  STOCK_ADJUSTMENTS = '/pos/inventory/stock-adjustments',
  PROFIT_LOSS = '/pos/reports/profit-loss',
  TRIAL_BALANCE = '/pos/reports/trial-balance',
  BALANCE_SHEET = '/pos/reports/balance-sheet',
  AR_AGING = '/pos/reports/ar-aging',
  AP_AGING = '/pos/reports/ap-aging',
  BOOKINGS = '/pos/bookings',
  SERVICES = '/pos/services',
  SERVICE_JOBS = '/pos/service-jobs',
  SERVICE_HELP = '/pos/help/service-workflow',
  BACKUP = '/pos/settings/backup',
  ADMIN_QUERIES = '/pos/settings/admin-queries',
  COMPANY_SETTINGS = '/pos/settings/company',
  LABEL_DESIGNER = '/pos/inventory/label-designer',
  AUDIT_LOGS = '/pos/security/audit-logs',
  INCOME_REPORT     = '/pos/reports/income',
  SALES_RANKING     = '/pos/reports/sales-ranking',
  SALES_SUMMARY     = '/pos/reports/sales-summary',
  PURCHASE_SUMMARY  = '/pos/reports/purchase-summary',
  SERVICE_SUMMARY   = '/pos/reports/service-summary',
  CUSTOMER_HISTORY  = '/pos/reports/customer-history',
  STAFF_PERFORMANCE = '/pos/reports/staff-performance',
  STOCK_REPORT      = '/pos/reports/stock',
  VOUCHER_SETTINGS     = '/pos/settings/voucher',
  SERVICE_BOOKING_SETTINGS = '/pos/settings/service-booking',
  APP_VERSION_SETTINGS = '/pos/settings/app-version',
  SHELF_LOCATIONS      = '/pos/services/shelf-locations',
  OUTDOOR_TRACKING     = '/pos/services/outdoor-tracking',
  VIDEOS               = '/pos/videos',
  OPENING_BALANCE          = '/pos/accounting/opening-balance',
  OPENING_STOCK            = '/pos/inventory/opening-stock',
  PAYMENT_TRANSACTIONS     = '/pos/accounting/payment-transactions',
  CUSTOMER_APP_ORDERS      = '/pos/crm/customer-app-orders',
  CUSTOMER_PROMO_CODES     = '/pos/crm/customer-promo-codes',
  DELIVERY_CHARGES         = '/pos/crm/delivery-charges',
  CUSTOMER_APP_ACCOUNTS    = '/pos/crm/customer-app-accounts',
  CUSTOMER_CHAT_INBOX      = '/pos/crm/customer-chat',
  DAILY_SNAPSHOT           = '/pos/reports/daily-snapshot'
}
