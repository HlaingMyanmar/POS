...
interface ApiService {
    ...
    @GET("sub-service-types/active/by-type/{typeId}")
    suspend fun getActiveSubServiceTypes(
        @Header("Authorization") auth: String,
        @Path("typeId") typeId: Int
    ): Response<ApiResponse<List<SubServiceTypeDTO>>>
    ...
    @GET("services/by-type/{typeId}")
    suspend fun getServiceItemsByType(
        @Header("Authorization") auth: String,
        @Path("typeId") typeId: Int
    ): Response<ApiResponse<List<ServiceItemDTO>>>

    @GET("services/{id}/price-history")
    suspend fun getServiceItemPriceHistory(
        @Header("Authorization") auth: String,
        @Path("id") id: Int
    ): Response<ApiResponse<List<ServicePriceHistoryDTO>>>
    ...
    @GET("service-jobs/by-booking/{bookingId}")
    suspend fun getServiceJobsByBooking(
        @Header("Authorization") auth: String,
        @Path("bookingId") bookingId: Int
    ): Response<ApiResponse<List<ServiceJobDTO>>>

    @GET("service-jobs/status/{status}")
    suspend fun getServiceJobsByStatus(
        @Header("Authorization") auth: String,
        @Path("status") status: String
    ): Response<ApiResponse<List<ServiceJobDTO>>>

    @GET("service-jobs/unpaid")
    suspend fun getUnpaidServiceJobs(
        @Header("Authorization") auth: String
    ): Response<ApiResponse<List<ServiceJobDTO>>>
    ...
    @GET("service-jobs/used-serial-numbers")
    suspend fun getUsedServiceSerialNumbers(
        @Header("Authorization") auth: String,
    ...
    @DELETE("service-jobs/{id}/attachments/{attachmentId}")
    suspend fun deleteServiceJobAttachment(
        @Header("Authorization") auth: String,
        @Path("id") id: Int,
        @Path("attachmentId") attachmentId: Int
    ): Response<ApiResponse<Void>>
    ...
    @GET("service-jobs/handovers/sent/mine")
    suspend fun mySentHandovers(
        @Header("Authorization") auth: String
    ): Response<ApiResponse<List<HandoverDTO>>>
    ...
    // ── Print ─────────────────────────────────────────────────────────────────
    @POST("print/preview")
    suspend fun getPrintPreviewHtml(
        @Header("Authorization") auth: String,
