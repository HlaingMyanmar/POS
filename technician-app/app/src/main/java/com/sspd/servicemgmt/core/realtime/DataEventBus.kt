...
import com.sspd.servicemgmt.core.network.DataEvent
...
object DataEventBus {
    ...
    private val _jobCreated = MutableSharedFlow<String>(extraBufferCapacity = 16)
    val jobCreated: SharedFlow<String> = _jobCreated.asSharedFlow()
